...
class TestForTaskEntry(TestCase):
    ...
    def test_for_set_details(self):
        ...
        self.assertEquals(
            test_object.set_details(Task_des='dsas', Task_priority=1, Task_weight=2, Task_schedule=1,
                                    Task_dependant='NULL'),
            "Record Inserted")
    ...
    def test_for_update_details(self):
        test_object = TaskEntry()
        self.assertEquals(
            test_object.update_record(Task_id=1, Task_des='dsas', Task_priority=1, Task_weight=2, Task_schedule=1,
                                      Task_dependant='NULL'),
            "Record Inserted")
    ...
    def test_for_priority_value_not_greater_than_5(self):
        test_object = TaskEntry()
        self.assertEquals(
            test_object.set_details(Task_des='dsas', Task_priority=10, Task_weight=2, Task_schedule=1,
                                    Task_dependant='NULL'),
    ...
    def test_for_weight_value_not_greater_than_5(self):
        test_object = TaskEntry()
        self.assertEquals(
            test_object.set_details(Task_des='dsas', Task_priority=1, Task_weight=6, Task_schedule=1,
                                    Task_dependant='NULL'),
            "Records Have constraint errors")
    ...
    def test_for_foreign_key_constraint_working_on_valid_Task_id(self):
        test_object = TaskEntry()
        test_object.set_details(Task_des='dsas', Task_priority=1, Task_weight=3, Task_schedule=1,
                                Task_dependant='NULL')
        self.assertEquals(
            test_object.set_details(Task_des='dsas', Task_priority=1, Task_weight=3, Task_schedule=1,
                                    Task_dependant=1),
    ...
    #                             Task_dependant='NULL')
        ...
        #     "list": [{'Task_id':3, 'Task_des': 'dsas', 'Task_priority': 1, 'Task_weight': 2, 'Task_dependant': 'None', 'Task_schedule': 1}]})
    ...
    #                                 {'Task_des': 'dsas', 'Task_priority': 1, 'Task_weight': 2,
    #                                  'Task_dependant':0, 'Task_schedule': 1})
    #
    #     self.assertJSONEqual(response.content, {'status': 'success'})

    #     # response = self.client.get('/api/getTask', {'Task_id': 1})
    #     # self.assertJSONEqual(response.content,
    #     #                      {'Task_id': '1', 'Task_des': 'dsas', 'Task_priority': 1, 'Task_weight': 2,
    #     #                       'Task_dependant': 'None',
    #     #                       'Task_schedule': 1})
    #
